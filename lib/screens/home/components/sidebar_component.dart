        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: ResponsiveWidget.isMediumScreen(context) ? null : Text('Sushant Aggarwal', style: boldTextStyle(size: 14)),
              subtitle: ResponsiveWidget.isMediumScreen(context) ? null : Text('Lead Manager', style: secondaryTextStyle(size: 12)),
            ),
          ],
        ),
      ),
